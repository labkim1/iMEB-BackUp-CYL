...
namespace TLog
{
    ...
    public static class Preconditions
    {
        ...
        public static void CheckArgumentRange([InvokerParameterName] string paramName, long value, long minInclusive, long maxInclusive)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(paramName, string.Format(BCPT.Properties.Resources.Preconditions_CheckArgumentRange, minInclusive, maxInclusive));
            }
        }
        ...
        public static void CheckNotDefault<T>(T value, [InvokerParameterName] string paramName = null)
        {
            ...
            {
                throw new ArgumentException(BCPT.Properties.Resources.Preconditions_CheckNotDefault_DefaultValue, paramName ?? "value");
            }
        }
    }
}